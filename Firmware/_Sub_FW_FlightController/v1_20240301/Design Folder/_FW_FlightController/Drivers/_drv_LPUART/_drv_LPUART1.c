...
static void _init_LPUART1( void )
{
  ...
  //Clearing the lpuart Flags
  lpuart1.txTransferCompleteFlag = false;
  lpuart1.rxTransferCompleteFlag = false;
