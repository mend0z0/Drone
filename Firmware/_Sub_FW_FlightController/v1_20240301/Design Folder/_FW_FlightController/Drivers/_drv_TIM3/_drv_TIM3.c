...
*****************************************************************************************************/
const uint32_t GPDMA_CHANNEL0_IRQ_PRIORITY = 1;	//
...
static void  _init_GPDMA( void )
{
  ...
  GPDMA1_Channel0->CTR2 |= 	DMA_CTR2_DREQ	|				// Selected hardware request driven by a destination peripheral
				(TIM3_UPD_DMA << DMA_CTR2_REQSEL_Pos)		// GPDMA hardware request selection
				;

  GPDMA1_Channel0->CBR1 = ((TIM3_BURST_NO) << DMA_CBR1_BNDT_Pos);		// block number of data bytes to transfer from the source

  GPDMA1_Channel0->CDAR = (uint32_t)(&TIM3->DMAR);				// The destination

  NVIC_SetPriority( GPDMA1_Channel0_IRQn, GPDMA_CHANNEL0_IRQ_PRIORITY);
...
/****************************************************************************************************
*   	@Brief Description:	Enable GPDMA for TIM3
*   	Function Status: 	PRELIMINARY   (DRAFT , PRELIMINARY, CHECKED, RELEASED)
*
*************************************************************************************************
*	Function Name:		GPDMAEnable()
*	Function Scope:         Local(static)
*	Function Parameters:	void
*	Function Return Type:	void
*************************************************************************************************
