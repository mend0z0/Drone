...
public:
    ...
    void setupUi(QMainWindow *Quadcopter_MainWindow)
    {
        ...
        pushButton_DroneSelectPrevious->setGeometry(QRect(478, 433, 50, 50));
        ...
        pushButton_DroneSelectNext->setGeometry(QRect(738, 433, 50, 50));
        ...
        graphicsView_DroneCameraView->setGeometry(QRect(310, 20, 651, 480));
        ...
        label_Time->setGeometry(QRect(320, 30, 120, 40));
        QFont font;
...
"color: rgb(255, 255, 255);"));
        ...
        pushButton_DroneCameraSnapshot->setGeometry(QRect(608, 433, 50, 50));
        ...
        verticalSlider_Throttle->setGeometry(QRect(895, 30, 40, 420));
        ...
        pushButton_MoveForward->setGeometry(QRect(1078, 350, 80, 80));
        QFont font1;
        ...
        pushButton_MoveLeft->setGeometry(QRect(964, 464, 80, 80));
        ...
        pushButton_MoveReverse->setGeometry(QRect(1079, 579, 80, 80));
        ...
        pushButton_MoveRight->setGeometry(QRect(1194, 465, 80, 80));
        ...
        dial_GeologicalPosition->setGeometry(QRect(1044, 440, 151, 131));
        ...
        layoutWidget->setGeometry(QRect(10, 20, 291, 641));
        ...
        gridLayout_3->addWidget(pushButton_SaveLogFile, 8, 0, 1, 1);
        ...
        gridLayout_3->addWidget(plainTextEdit_LogPanel, 7, 0, 1, 1);
        ...
        gridLayout_2->addWidget(label_LoRaWANServer, 10, 0, 1, 1);

        label_UDPConnection = new QLabel(layoutWidget);
        label_UDPConnection->setObjectName("label_UDPConnection");

        gridLayout_2->addWidget(label_UDPConnection, 13, 0, 1, 1);

        label_ApplicationIPV4 = new QLabel(layoutWidget);
        label_ApplicationIPV4->setObjectName("label_ApplicationIPV4");

        gridLayout_2->addWidget(label_ApplicationIPV4, 14, 0, 1, 1);

        label_LoRaWANFrequency = new QLabel(layoutWidget);
        label_LoRaWANFrequency->setObjectName("label_LoRaWANFrequency");

        gridLayout_2->addWidget(label_LoRaWANFrequency, 11, 0, 1, 1);

        label_MQTTServer = new QLabel(layoutWidget);
        label_MQTTServer->setObjectName("label_MQTTServer");
        label_MQTTServer->setFont(font3);

        gridLayout_2->addWidget(label_MQTTServer, 12, 0, 1, 1);

        label_StatusUDPConnection = new QLabel(layoutWidget);
        label_StatusUDPConnection->setObjectName("label_StatusUDPConnection");

        gridLayout_2->addWidget(label_StatusUDPConnection, 13, 1, 1, 1);
        ...
        gridLayout_3->addWidget(pushButton_ServerSetting, 4, 0, 1, 1);

        graphicsView_Camera3 = new QGraphicsView(centralwidget);
        graphicsView_Camera3->setObjectName("graphicsView_Camera3");
        graphicsView_Camera3->setGeometry(QRect(700, 560, 128, 96));
        ...
        graphicsView_Camera4->setGeometry(QRect(830, 560, 128, 96));
        ...
        graphicsView_Camera2->setGeometry(QRect(570, 560, 128, 96));
        ...
        graphicsView_Camera1->setGeometry(QRect(440, 560, 128, 96));
        ...
        graphicsView_Camera0->setGeometry(QRect(310, 560, 128, 96));
        ...
        label_Logo->setGeometry(QRect(1100, 490, 41, 31));
        ...
        label_Camera1->setGeometry(QRect(310, 540, 128, 121));
        ...
        label_F24->setGeometry(QRect(1134, 405, 10, 10));
        ...
        label_F41->setGeometry(QRect(1084, 390, 10, 10));
        ...
        label_F32->setGeometry(QRect(1104, 390, 10, 10));
        ...
        label_F33->setGeometry(QRect(1124, 390, 10, 10));
        ...
        label_F43->setGeometry(QRect(1144, 390, 10, 10));
        ...
        label_F51->setGeometry(QRect(1094, 380, 10, 10));
        ...
        label_F42->setGeometry(QRect(1114, 380, 10, 10));
        ...
        label_F52->setGeometry(QRect(1134, 380, 10, 10));
        ...
        label_F61->setGeometry(QRect(1104, 370, 10, 10));
        ...
        label_F62->setGeometry(QRect(1124, 370, 10, 10));
        ...
        label_F71->setGeometry(QRect(1114, 360, 10, 10));
        ...
        label_F23->setGeometry(QRect(1114, 400, 10, 10));
        ...
        label_B71->setGeometry(QRect(1114, 640, 10, 10));
        ...
        label_B22->setGeometry(QRect(1134, 595, 10, 10));
        ...
        label_B43->setGeometry(QRect(1084, 610, 10, 10));
        ...
        label_B52->setGeometry(QRect(1094, 620, 10, 10));
        ...
        label_B41->setGeometry(QRect(1144, 610, 10, 10));
        ...
        label_B51->setGeometry(QRect(1134, 620, 10, 10));
        ...
        label_B62->setGeometry(QRect(1104, 630, 10, 10));
        ...
        label_B61->setGeometry(QRect(1124, 630, 10, 10));
        ...
        label_B42->setGeometry(QRect(1114, 620, 10, 10));
        ...
        label_B32->setGeometry(QRect(1124, 610, 10, 10));
        ...
        label_B23->setGeometry(QRect(1114, 600, 10, 10));
        ...
        label_B33->setGeometry(QRect(1104, 610, 10, 10));
        ...
        label_B24->setGeometry(QRect(1094, 595, 10, 10));
        ...
        label_R61->setGeometry(QRect(1244, 490, 10, 10));
        ...
        label_R22->setGeometry(QRect(1209, 480, 10, 10));
        ...
        label_R42->setGeometry(QRect(1234, 500, 10, 10));
        ...
        label_R62->setGeometry(QRect(1244, 510, 10, 10));
        ...
        label_R71->setGeometry(QRect(1254, 500, 10, 10));
        ...
        label_R51->setGeometry(QRect(1234, 480, 10, 10));
        ...
        label_R43->setGeometry(QRect(1224, 530, 10, 10));
        ...
        label_R33->setGeometry(QRect(1224, 510, 10, 10));
        ...
        label_R41->setGeometry(QRect(1224, 470, 10, 10));
        ...
        label_R32->setGeometry(QRect(1224, 490, 10, 10));
        ...
        label_R24->setGeometry(QRect(1209, 520, 10, 10));
        ...
        label_R52->setGeometry(QRect(1234, 520, 10, 10));
        ...
        label_R23->setGeometry(QRect(1214, 500, 10, 10));
        ...
        label_L22->setGeometry(QRect(1019, 520, 10, 10));
        ...
        label_L33->setGeometry(QRect(1004, 490, 10, 10));
        ...
        label_L52->setGeometry(QRect(994, 480, 10, 10));
        ...
        label_L71->setGeometry(QRect(974, 500, 10, 10));
        ...
        label_L43->setGeometry(QRect(1004, 470, 10, 10));
        ...
        label_L61->setGeometry(QRect(984, 510, 10, 10));
        ...
        label_L41->setGeometry(QRect(1004, 530, 10, 10));
        ...
        label_L62->setGeometry(QRect(984, 490, 10, 10));
        ...
        label_L32->setGeometry(QRect(1004, 510, 10, 10));
        ...
        label_L51->setGeometry(QRect(994, 520, 10, 10));
        ...
        label_L42->setGeometry(QRect(994, 500, 10, 10));
        ...
        label_L23->setGeometry(QRect(1014, 500, 10, 10));
        ...
        label_L24->setGeometry(QRect(1019, 480, 10, 10));
        ...
        label_CompassOff->setGeometry(QRect(1050, 436, 140, 140));
        ...
        label_DroneCameraView->setGeometry(QRect(310, 20, 651, 481));
        ...
        label_Camera1_2->setGeometry(QRect(310, 560, 124, 90));
        ...
        label_Camera2_2->setGeometry(QRect(440, 560, 124, 90));
        ...
        label_Camera3_2->setGeometry(QRect(570, 560, 124, 90));
        ...
        label_Camera5_2->setGeometry(QRect(830, 560, 124, 90));
        ...
        label_Camera4_2->setGeometry(QRect(700, 560, 124, 90));
        ...
        lcdNumber_ValueThrottle->setGeometry(QRect(895, 460, 40, 30));
...
"color: rgb(255, 255, 255);"));
        ...
        progressBar_ValueBatteryCharge->setGeometry(QRect(320, 80, 120, 20));
        ...
        label_CompasOnSpot->setGeometry(QRect(1048, 436, 140, 140));
        ...
        layoutWidget1->setGeometry(QRect(975, 20, 281, 331));
        gridLayout_4 = new QGridLayout(layoutWidget1);
        gridLayout_4->setObjectName("gridLayout_4");
        gridLayout_4->setContentsMargins(0, 0, 0, 0);
        pushButton_ConnectLoRaWAN = new QPushButton(layoutWidget1);
        ...
        gridLayout_4->addWidget(pushButton_ConnectLoRaWAN, 0, 0, 1, 1);
        ...
        gridLayout->addWidget(lcdNumber_ValueTemperature, 8, 0, 1, 1);

        label_Pressure = new QLabel(layoutWidget1);
        label_Pressure->setObjectName("label_Pressure");

        gridLayout->addWidget(label_Pressure, 12, 0, 1, 1);

        label_Temperature = new QLabel(layoutWidget1);
        label_Temperature->setObjectName("label_Temperature");

        gridLayout->addWidget(label_Temperature, 6, 0, 1, 1);

        label_Displacement = new QLabel(layoutWidget1);
        label_Displacement->setObjectName("label_Displacement");

        gridLayout->addWidget(label_Displacement, 6, 1, 1, 1);

        label_DroneIPV4 = new QLabel(layoutWidget1);
        label_DroneIPV4->setObjectName("label_DroneIPV4");

        gridLayout->addWidget(label_DroneIPV4, 5, 0, 1, 1);

        label_ValueDroneIPV4 = new QLabel(layoutWidget1);
        label_ValueDroneIPV4->setObjectName("label_ValueDroneIPV4");

        gridLayout->addWidget(label_ValueDroneIPV4, 5, 1, 1, 1);
