...
public:
    ...
    QLabel *label_ValueApplicationIPAddress;
    ...
    QLabel *label_ActiveDrone;
    QLabel *label_ValueActiveDrone;
    QLCDNumber *lcdNumber_ValueThrottleValue;
...
"color: rgb(255, 255, 255);"));
        ...
        pushButton_MoveForward->setGeometry(QRect(1074, 350, 80, 80));
        QFont font1;
        ...
        pushButton_MoveLeft->setGeometry(QRect(960, 464, 80, 80));
        ...
        pushButton_MoveReverse->setGeometry(QRect(1075, 579, 80, 80));
        ...
        pushButton_MoveRight->setGeometry(QRect(1190, 465, 80, 80));
        ...
        dial_GeologicalPosition->setGeometry(QRect(1040, 440, 151, 131));
        ...
        layoutWidget->setGeometry(QRect(10, 50, 291, 611));
        ...
        label_ValueApplicationIPAddress = new QLabel(layoutWidget);
        label_ValueApplicationIPAddress->setObjectName("label_ValueApplicationIPAddress");

        gridLayout_2->addWidget(label_ValueApplicationIPAddress, 8, 1, 1, 1);
        ...
        label_LoRaWANFrequency = new QLabel(layoutWidget);
        label_LoRaWANFrequency->setObjectName("label_LoRaWANFrequency");

        gridLayout_2->addWidget(label_LoRaWANFrequency, 10, 0, 1, 1);
        ...
        label_ValueLoRaWANFrequency = new QLabel(layoutWidget);
        label_ValueLoRaWANFrequency->setObjectName("label_ValueLoRaWANFrequency");

        gridLayout_2->addWidget(label_ValueLoRaWANFrequency, 10, 1, 1, 1);

        label_StatusLoRaWANServer = new QLabel(layoutWidget);
        label_StatusLoRaWANServer->setObjectName("label_StatusLoRaWANServer");

        gridLayout_2->addWidget(label_StatusLoRaWANServer, 9, 1, 1, 1);

        label_MQTTServer = new QLabel(layoutWidget);
        label_MQTTServer->setObjectName("label_MQTTServer");
        QFont font4;
        font4.setFamilies({QString::fromUtf8("Calibri Light")});
        label_MQTTServer->setFont(font4);

        gridLayout_2->addWidget(label_MQTTServer, 6, 0, 1, 1);
        ...
        label_ApplicationIP = new QLabel(layoutWidget);
        label_ApplicationIP->setObjectName("label_ApplicationIP");

        gridLayout_2->addWidget(label_ApplicationIP, 8, 0, 1, 1);

        label_LoRaWANServer = new QLabel(layoutWidget);
        label_LoRaWANServer->setObjectName("label_LoRaWANServer");
        label_LoRaWANServer->setFont(font4);

        gridLayout_2->addWidget(label_LoRaWANServer, 9, 0, 1, 1);
        ...
        label_Logo->setGeometry(QRect(1096, 490, 41, 31));
        ...
        label_F22->setGeometry(QRect(1090, 405, 10, 10));
        ...
        label_F24->setGeometry(QRect(1130, 405, 10, 10));
        ...
        label_F41->setGeometry(QRect(1080, 390, 10, 10));
        ...
        label_F32->setGeometry(QRect(1100, 390, 10, 10));
        ...
        label_F33->setGeometry(QRect(1120, 390, 10, 10));
        ...
        label_F43->setGeometry(QRect(1140, 390, 10, 10));
        ...
        label_F51->setGeometry(QRect(1090, 380, 10, 10));
        ...
        label_F42->setGeometry(QRect(1110, 380, 10, 10));
        ...
        label_F52->setGeometry(QRect(1130, 380, 10, 10));
        ...
        label_F61->setGeometry(QRect(1100, 370, 10, 10));
        ...
        label_F62->setGeometry(QRect(1120, 370, 10, 10));
        ...
        label_F71->setGeometry(QRect(1110, 360, 10, 10));
        ...
        label_F23->setGeometry(QRect(1110, 400, 10, 10));
        ...
        label_B71->setGeometry(QRect(1110, 640, 10, 10));
        ...
        label_B22->setGeometry(QRect(1130, 595, 10, 10));
        ...
        label_B43->setGeometry(QRect(1080, 610, 10, 10));
        ...
        label_B52->setGeometry(QRect(1090, 620, 10, 10));
        ...
        label_B41->setGeometry(QRect(1140, 610, 10, 10));
        ...
        label_B51->setGeometry(QRect(1130, 620, 10, 10));
        ...
        label_B62->setGeometry(QRect(1100, 630, 10, 10));
        ...
        label_B61->setGeometry(QRect(1120, 630, 10, 10));
        ...
        label_B42->setGeometry(QRect(1110, 620, 10, 10));
        ...
        label_B32->setGeometry(QRect(1120, 610, 10, 10));
        ...
        label_B23->setGeometry(QRect(1110, 600, 10, 10));
        ...
        label_B33->setGeometry(QRect(1100, 610, 10, 10));
        ...
        label_B24->setGeometry(QRect(1090, 595, 10, 10));
        ...
        label_R61->setGeometry(QRect(1240, 490, 10, 10));
        ...
        label_R22->setGeometry(QRect(1205, 480, 10, 10));
        ...
        label_R42->setGeometry(QRect(1230, 500, 10, 10));
        ...
        label_R62->setGeometry(QRect(1240, 510, 10, 10));
        ...
        label_R71->setGeometry(QRect(1250, 500, 10, 10));
        ...
        label_R51->setGeometry(QRect(1230, 480, 10, 10));
        ...
        label_R43->setGeometry(QRect(1220, 530, 10, 10));
        ...
        label_R33->setGeometry(QRect(1220, 510, 10, 10));
        ...
        label_R41->setGeometry(QRect(1220, 470, 10, 10));
        ...
        label_R32->setGeometry(QRect(1220, 490, 10, 10));
        ...
        label_R24->setGeometry(QRect(1205, 520, 10, 10));
        ...
        label_R52->setGeometry(QRect(1230, 520, 10, 10));
        ...
        label_R23->setGeometry(QRect(1210, 500, 10, 10));
        ...
        label_L22->setGeometry(QRect(1015, 520, 10, 10));
        ...
        label_L33->setGeometry(QRect(1000, 490, 10, 10));
        ...
        label_L52->setGeometry(QRect(990, 480, 10, 10));
        ...
        label_L71->setGeometry(QRect(970, 500, 10, 10));
        ...
        label_L43->setGeometry(QRect(1000, 470, 10, 10));
        ...
        label_L61->setGeometry(QRect(980, 510, 10, 10));
        ...
        label_L41->setGeometry(QRect(1000, 530, 10, 10));
        ...
        label_L62->setGeometry(QRect(980, 490, 10, 10));
        ...
        label_L32->setGeometry(QRect(1000, 510, 10, 10));
        ...
        label_L51->setGeometry(QRect(990, 520, 10, 10));
        ...
        label_L42->setGeometry(QRect(990, 500, 10, 10));
        ...
        label_L23->setGeometry(QRect(1010, 500, 10, 10));
        ...
        label_L24->setGeometry(QRect(1015, 480, 10, 10));
        ...
        label_CompassOff->setGeometry(QRect(1046, 436, 140, 140));
        ...
        layoutWidget1->setGeometry(QRect(975, 60, 291, 271));
        gridLayout = new QGridLayout(layoutWidget1);
        gridLayout->setObjectName("gridLayout");
        gridLayout->setContentsMargins(0, 0, 0, 0);
        lcdNumber_ValueHeight = new QLCDNumber(layoutWidget1);
        lcdNumber_ValueHeight->setObjectName("lcdNumber_ValueHeight");

        gridLayout->addWidget(lcdNumber_ValueHeight, 11, 1, 1, 1);

        label_Speed = new QLabel(layoutWidget1);
        label_Speed->setObjectName("label_Speed");

        gridLayout->addWidget(label_Speed, 7, 1, 1, 1);

        label_Displacement = new QLabel(layoutWidget1);
        label_Displacement->setObjectName("label_Displacement");

        gridLayout->addWidget(label_Displacement, 3, 1, 1, 1);

        lcdNumber_ValueHumidity = new QLCDNumber(layoutWidget1);
        lcdNumber_ValueHumidity->setObjectName("lcdNumber_ValueHumidity");

        gridLayout->addWidget(lcdNumber_ValueHumidity, 8, 0, 1, 1);

        label_Height = new QLabel(layoutWidget1);
        label_Height->setObjectName("label_Height");

        gridLayout->addWidget(label_Height, 9, 1, 1, 1);

        lcdNumber_ValueSpeed = new QLCDNumber(layoutWidget1);
        lcdNumber_ValueSpeed->setObjectName("lcdNumber_ValueSpeed");

        gridLayout->addWidget(lcdNumber_ValueSpeed, 8, 1, 1, 1);

        label_Humedity = new QLabel(layoutWidget1);
        label_Humedity->setObjectName("label_Humedity");

        gridLayout->addWidget(label_Humedity, 7, 0, 1, 1);

        label_Pressure = new QLabel(layoutWidget1);
        label_Pressure->setObjectName("label_Pressure");

        gridLayout->addWidget(label_Pressure, 9, 0, 1, 1);

        label_Temperature = new QLabel(layoutWidget1);
        label_Temperature->setObjectName("label_Temperature");

        gridLayout->addWidget(label_Temperature, 3, 0, 1, 1);

        lcdNumber_ValueTemperature = new QLCDNumber(layoutWidget1);
        lcdNumber_ValueTemperature->setObjectName("lcdNumber_ValueTemperature");

        gridLayout->addWidget(lcdNumber_ValueTemperature, 5, 0, 1, 1);

        lcdNumber_ValuePressure = new QLCDNumber(layoutWidget1);
        lcdNumber_ValuePressure->setObjectName("lcdNumber_ValuePressure");

        gridLayout->addWidget(lcdNumber_ValuePressure, 11, 0, 1, 1);

        lcdNumber_ValueDisplacement = new QLCDNumber(layoutWidget1);
        ...
        gridLayout->addWidget(lcdNumber_ValueDisplacement, 5, 1, 1, 1);

        label_DroneType = new QLabel(layoutWidget1);
        label_DroneType->setObjectName("label_DroneType");

        gridLayout->addWidget(label_DroneType, 2, 0, 1, 1);

        label_ValueDroneType = new QLabel(layoutWidget1);
        label_ValueDroneType->setObjectName("label_ValueDroneType");

        gridLayout->addWidget(label_ValueDroneType, 2, 1, 1, 1);

        label_ActiveDrone = new QLabel(layoutWidget1);
        label_ActiveDrone->setObjectName("label_ActiveDrone");
        label_ActiveDrone->setFont(font4);

        gridLayout->addWidget(label_ActiveDrone, 1, 0, 1, 1);

        label_ValueActiveDrone = new QLabel(layoutWidget1);
        label_ValueActiveDrone->setObjectName("label_ValueActiveDrone");

        gridLayout->addWidget(label_ValueActiveDrone, 1, 1, 1, 1);

        lcdNumber_ValueThrottleValue = new QLCDNumber(centralwidget);
        lcdNumber_ValueThrottleValue->setObjectName("lcdNumber_ValueThrottleValue");
        lcdNumber_ValueThrottleValue->setGeometry(QRect(890, 490, 40, 30));
        lcdNumber_ValueThrottleValue->setStyleSheet(QString::fromUtf8("background-color: rgb(0, 0, 199);\n"
"color: rgb(255, 255, 255);"));
        lcdNumber_ValueThrottleValue->setDigitCount(3);
        ...
        progressBar_ValueBatteryCharge->setGeometry(QRect(315, 110, 120, 20));
        ...
        label_CompasOnSpot->setGeometry(QRect(1044, 436, 140, 140));
        ...
        label_L23->raise();
        label_L24->raise();
        lcdNumber_ValueThrottleValue->raise();
    ...
    void retranslateUi(QMainWindow *Quadcopter_MainWindow)
    {
        ...
        label_ValueApplicationIPAddress->setText(QCoreApplication::translate("Quadcopter_MainWindow", "<html><head/><body><p><span style=\" font-size:12pt;\">---.---.---.---</span></p></body></html>", nullptr));
        pushButton_ServerSetting->setText(QCoreApplication::translate("Quadcopter_MainWindow", "Server Setting", nullptr));
        label_LoRaWANFrequency->setText(QCoreApplication::translate("Quadcopter_MainWindow", "<html><head/><body><p><span style=\" font-size:12pt;\">LoRaWAN Frequency</span></p></body></html>", nullptr));
        pushButton_ConnectLoRaWAN->setText(QCoreApplication::translate("Quadcopter_MainWindow", "Drone Setting", nullptr));
        label_ValueLoRaWANFrequency->setText(QCoreApplication::translate("Quadcopter_MainWindow", "<html><head/><body><p><span style=\" font-size:12pt;\">--- MHz</span></p></body></html>", nullptr));
        ...
        label_ApplicationIP->setText(QCoreApplication::translate("Quadcopter_MainWindow", "<html><head/><body><p><span style=\" font-size:12pt;\">Application IP</span></p></body></html>", nullptr));
        ...
        label_ActiveDrone->setText(QCoreApplication::translate("Quadcopter_MainWindow", "<html><head/><body><p><span style=\" font-size:12pt;\">Active Drone</span></p></body></html>", nullptr));
        label_ValueActiveDrone->setText(QCoreApplication::translate("Quadcopter_MainWindow", "<html><head/><body><p><span style=\" font-size:12pt;\">0/99</span></p></body></html>", nullptr));
